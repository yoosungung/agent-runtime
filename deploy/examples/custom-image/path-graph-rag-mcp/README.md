...
워크플로: [`.github/workflows/build-images.yml`](../../../../.github/workflows/build-images.yml) matrix `path-graph-rag-mcp` · 단독 [`path-graph-rag-mcp.yml`](../../../../.github/workflows/path-graph-rag-mcp.yml). `path-graph`는 GitHub Release wheel(`v0.1.4`)에서 설치 — repo checkout·staging 없음.
