"""MCP SDK calendar-outlook bundle — Microsoft 365 Calendar via Graph.
...
from client import OutlookGraphCalendarClient  # noqa: E402
...
def build_server(cfg: dict, secrets) -> Any:
    ...
    client = OutlookGraphCalendarClient(cfg, secrets)

    server = Server("calendar-outlook")
