...
import { usePipelineProject, usePipelineSources } from "../../pipeline/hooks/usePipeline";
import {
  useCleanupProject,
  usePurgeProject,
  usePurgeSource,
...
export function FilesMaintenancePage() {
  ...
  return (
    <div>
      <PageHeader title={project ? `${project.name} — Maintenance` : "Maintenance"} />
      ...
      <div className="space-y-6 max-w-2xl">
        ...
        <section className="bg-white shadow rounded-lg p-4">
          ...
          <p className="text-sm text-gray-600 mb-3">미사용 S3 artifact 정리 (dry-run 먼저 권장).</p>
